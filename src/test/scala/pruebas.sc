...
insert[Int](2, ascList, menorQue)
insert[Int](2, descList, mayorQue)
...
val iSort_Asc_Char = insertionSort[Char]((a:Char, b:Char)=>a<b)
val iSort_Asc_Str = insertionSort[String]((a:String,b:String)=>a<b)
...
menoresQue_noMenoresQue[Int](ascList, 1, menorQue)
menoresQue_noMenoresQue[Int](mixList, 3, mayorQue)
menoresQue_noMenoresQue[Char](charList, 'd', (a:Char,b:Char)=>a<b)
menoresQue_noMenoresQue[String](stringList, "Natalia", (a:String,b:String)=>a<b)
...
comparar(iSort_Asc_Char, qSort_Asc_Char, charList)
